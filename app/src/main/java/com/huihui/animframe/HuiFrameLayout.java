...
/**
 * Created by molu_ on 2017/7/1.
 *
 */

public class HuiFrameLayout extends FrameLayout implements HuiScrollInterface{
    ...
    public HuiFrameLayout(@NonNull Context context) {
        super(context);
    }

    public HuiFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
